...
include_once MAIN_FILE . '/header.inc.php';?>
	...
	<div class = "m-content about-blogs">
		...
		<p>Чтобы создать свой блог и делать публикации переходите в раздел <a href = "../myblogs"><strong>Мои блоги</strong></a>. Присоеденяйтесь к числу авторов нашего сообщества <strong>imagoz.ru</strong>! Подробнее о блогах смотрите <a href = "../blog/aboutblogs">здесь</a></p>
	</div>
