...
<div class = "main-headers">
	...
	<div class = "main-headers">
        <div class = "headers-places"> 
            <div class = "main-headers-place"><a href="../viewmetanews/?metaid=<?php echo $idCategory; ?>">Новости</a></div>
        </div>
	...
	<div class = "main-headers">
        <div class = "headers-places"> 
            <div class = "main-headers-place"><a href="../viewmetapromotion/?metaid=<?php echo $idCategory; ?>">Промоушен</a></div>
        </div>
        <div class = "main-headers-line"></div>
    </div>
	...
	<div class = "main-headers">
        <div class = "headers-places"> 
            <div class = "main-headers-place"><a href="../viewmetapost/?metaid=<?php echo $idCategory; ?>">Статьи</a></div>
        </div>
        <div class = "main-headers-line"></div>
    </div>
