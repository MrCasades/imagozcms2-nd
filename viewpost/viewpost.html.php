		...
		<div class="columns__panel">
         <div class="columns__panel-content">
			<div class = "post_for_columns" style = "background: url(../images/<?php echo $post_1['imghead']; ?>); background-size: cover; ">
				<strong><a href="../viewpost/?id=<?php htmlecho ($post_1['id']); ?>" rel = "nofollow">.</a></strong> 
			</div>
			<strong><a href="../viewpost/?id=<?php htmlecho ($post_1['id']); ?>"><?php htmlecho ((implode(' ', array_slice(explode(' ', strip_tags($post_1['posttitle'])), 0, 7)))); ?>...</a></strong> 
		  </div>	 
		</div>	 
		 <?php endforeach; ?>
	   </div>
