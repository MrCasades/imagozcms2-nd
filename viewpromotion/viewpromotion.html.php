	...
	<div class="article-row">
		...
		<?php
			...
			<div class = "similar-art">
				...
				foreach ($similarPromotion as $promotion_1): ?>
					
				<a href = "../viewpromotion/?id=<?php htmlecho ($promotion_1['id']); ?>" class = "post-place-grid" style="background-image: url(../images/<?php echo $promotion_1['imghead']; ?>)">
					<div class = "post-bottom-1"><?php htmlecho ((implode(' ', array_slice(explode(' ', strip_tags($promotion_1['promotiontitle'])), 0, 7)))); ?>...</div>
				</a> 
				<?php endforeach; ?>
			</div>
			<!-- <div class="zen-c-m">
