	...
	<div class="main-row">
		...
		<div class="right-side">
				...
				<div class = "similar-art">
					...
					<a href = "../viewpromotion/?id=<?php htmlecho ($post_1['id']); ?>" class = "post-place-grid" style="background-image: url(../images/<?php echo $post_1['imghead']; ?>)">
		...
		<?php if (empty ($comments))
			...
			<div class="comment m-content">
				...
				<div class="m-content" id="hide_open_pl_<?php echo $comment['id']; ?>" style="display: none;"><a href="#" id="subcomment_hide_<?php echo $comment['id']; ?>">Скрыть</a> <a href="../viewwallpost/?id=<?php echo $comment['id']; ?>&typeart=prom&idart=<?php echo $idPromotion; ?>">Все ответы</a></div>
		...
		<div class="page-output">	
		 <?php
			...
			for ($i = 1; $i <= $pagesCount; $i++) 
			{
				...
				if($i == $page)
				{
					echo "<a href='./viewpromotion/?id=".$idPromotion."&page=$i'><button class='btn_2'>$i</button></a> ";
				} 
				else 
				{
					echo "<a href='./viewpromotion/?id=".$idPromotion."&page=$i'><button class='btn_1'>$i</button></a> ";
				}
			}?>
</div>
