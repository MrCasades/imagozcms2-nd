<div class="newsblock-rs">	
	...
	<div class = "similar-art">
		...
		<a href = "//<?php htmlecho (MAIN_URL); ?>/blog/publication/?id=<?php htmlecho ($blogs_rs['id']); ?>" class = "post-place-grid" style="background-image: url(//<?php htmlecho (MAIN_URL); ?>/images/<?php echo $blogs_rs['imghead']; ?>)">
