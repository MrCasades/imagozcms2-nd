<script>
    $(document).ready(function() {
        ...
        $('#like_sc_<?php echo $comment['id']; ?>').click(function(e) {

            $('#type_like_<?php echo $comment['id'];?>[name="type-like"]').val('like');
            pushLikeSc();
            if($("#like_form_sc_<?php echo $comment['id'];?>").find('input[name="idauthor"]').val() > 0){
                changeClass('like');
            }       
            e.preventDefault(); 
            console.log($('#type_like_sc_<?php echo $comment['id'];?>[name="type-like"]').val());
        })

        $('#dislike_sc_<?php echo $comment['id']; ?>').click(function(e) {
            $('#type_like_sc_<?php echo $comment['id'];?>[name="type-like"]').val('dislike');
            pushLike();    
            if($("#like_form_sc_<?php echo $comment['id'];?>").find('input[name="idauthor"]').val() > 0){
