...
<div class = "m-content addupd-post">
    ...
    <?php elseif (userRole('Администратор')):?>
        ...
        <a href="//<?php echo MAIN_URL;?>/admin/premoderation/secondblogpremoderation/"><button class="btn_2">Повторная премодерация статей блогов ("<?php echo $premodPubsSec;?>")</button></a>
