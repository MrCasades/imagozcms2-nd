...
<?php else:?>
	<div class = "logpanel">
		<form action = " " method = "post">
				...
				<a href="//<?php echo MAIN_URL;?>/mainmessages/"><button type="button" class="btn_2"><strong><i class="fa fa-envelope" aria-hidden="true"></i> СООБЩЕНИЯ <span id = "countcolor"><?php echo $unreadCount;?></span></strong></button></a>  
				<?php echo $panel;?> | 
