            ...
            <script>
                $('#btn<?php htmlecho ($searshedMeta['idmeta']);?>').click(function(){
                    if (!$('#prew<?php htmlecho ($searshedMeta['idmeta']);?>').length){
                        $('#checked-tags').append('<span class="tags-plase-prew" id="prew'+<?php htmlecho ($searshedMeta['idmeta']);?>+'" title="'+'<?php htmlecho ($searshedMeta['metaname']);?>'+'">'+'<?php htmlecho ($searshedMeta['metaname']);?>'+' <span onclick="RemoveTag('+<?php htmlecho ($searshedMeta['idmeta']);?>+')" id="remove'+<?php htmlecho ($searshedMeta['idmeta']);?>+'"><i class="fa fa-window-close-o" aria-hidden="true"></i></span></span>')
