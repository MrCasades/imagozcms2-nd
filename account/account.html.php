...
<main>
	...
	<div class="comment m-content">
		...
		<div class="m-content form-pl" id = "answ_<?php echo $comment['id'];?>" style="display: none;">
			...
			<div class="m-content" id="hide_open_pl_<?php echo $comment['id']; ?>" style="display: none;"><a href="#" id="subcomment_hide_<?php echo $comment['id']; ?>">Скрыть</a> <a href="../viewwallpost/?id=<?php echo $comment['id']; ?>&typeart=acc&idart=<?php echo $idAuthor;?>">Все ответы</a></div>
